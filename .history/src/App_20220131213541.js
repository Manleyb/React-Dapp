...
export function App() {
  ...
  return (
   ...
   <Document file={samplePDF}>
    ...
    <br href="https://www.westsideseattle.com/west-seattle-herald/2018/07/31/bryce-manley-demonstrates-what-it-takes-be-eagle-scout/">Link to Westside Seattle article 'Bryce Manley demonstrates what it takes to be an Eagle Scout'</br>
